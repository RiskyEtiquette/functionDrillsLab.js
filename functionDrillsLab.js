...
const arrayEvaluator = bigOrSmall([1, 101, 102, 2, 103, 4, 5, 6, 107]);
...
function isAscending(array) {
  /*
  This function takes in one parameter - array.
  Inside the function, it checks whether the array is sorted in ascending order.
  If it is sorted in ascending order, it returns true. Otherwise, it returns false.
  */
...
let arrayIsAscending = isAscending([0,1,2,3,4,7,8,8,8,9]);
